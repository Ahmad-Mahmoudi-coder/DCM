...
TIMES-NZ 3.0 aggregates New Zealand to two regions — broadly North Island and South Island — connected by the HVDC inter-island link. This captures the fundamental geographic constraint of the NZ electricity system without representing the distribution-level constraints within each island that determine site-level feasibility.
