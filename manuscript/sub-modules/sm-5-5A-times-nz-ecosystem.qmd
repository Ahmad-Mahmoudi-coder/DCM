...
TIMES-NZ sensitivity analysis is conducted through scenario comparison rather than probabilistic or DMDU-style ensemble evaluation. Typical studies vary one parameter at a time across a set of internally consistent configurations: high versus low electricity demand growth, faster versus slower EV uptake, different carbon price trajectories, alternative technology cost assumptions. Each scenario produces a complete optimal investment pathway for the national system.
