...
| **Assumes** | Modules 1 and 2 — the seven requirements of Module 1 §1.7 are the specification this module's architecture is designed to satisfy; the tools of Module 2 are what the architecture organises |
