...
| **Passes to** | §0.3, Module 5, Module 6 §6.9 |
| **Sub-Modules here** | None |
:::
...
![Figure 0.1: Seven analytical layers of the 
Decision-Centred Modelling framework — artefact 
exchange across the governed backbone.](
../assets/figures/diagram1-architecture-stack.png
