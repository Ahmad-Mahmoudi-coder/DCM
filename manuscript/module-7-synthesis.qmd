...
## §7.9 Beyond Infrastructure: Personal, Organisational, and Financial Decisions

::: {.callout-note collapse="false" icon="false"}
## Node Declaration — §7.9 Beyond Infrastructure: General Application

| Field | Content |
|---|---|
| **Tier** | Section |
| **Status** | ◇ Vision `[Educational]` |
| **Assumes** | §7.3 (Multi-Domain Extension) |
| **Contributes** | Shows how the decision-centred framework applies to personal long-horizon decisions and organisational strategy, not only to infrastructure or engineering contexts |
| **Skip condition** | Skip if reader is interested only in technical infrastructure applications |
| **Passes to** | Nothing (terminal section) |
| **Sub-Modules here** | None |
:::
...
## §7.10 Governed Expert Attestation: A Community Quality Architecture

::: {.callout-note collapse="false" icon="false"}
## Node Declaration — §7.10 Governed Expert Attestation

| Field | Content |
|---|---|
| **Tier** | Section |
| **Status** | ◇ Vision `[Platform]` `[Collaborative]` |
| **Assumes** | §7.8 (Open Knowledge Architecture), §7.9 (Beyond Infrastructure) |
| **Contributes** | Proposes a claim-level expert attestation mechanism as the quality governance layer for community-contributed extensions to the framework, and connects the attestation logic to the framework's ValidationArtefact architecture |
| **Skip condition** | Skip if reader is not interested in scholarly communication architecture |
| **Passes to** | Nothing — terminal section |
| **Sub-Modules here** | None |
:::
...
::: {.callout-tip}
## Contribute an Attestation `[Collaborative]`

If you have domain expertise relevant to any claim in 
this manuscript, you are invited to submit an attestation 
through GitHub Issues. The claims register and submission 
template are maintained at:

[github.com/Ahmad-Mahmoudi-coder/DCM](
https://github.com/Ahmad-Mahmoudi-coder/DCM){target="_blank"}

Attestations from any epistemic community relevant to 
the framework's claims are welcomed.
:::
