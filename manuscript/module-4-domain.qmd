...
| **Assumes** | Module 3 in full; Module 1 §1.5 and Module 1 §1.6 for the evaluative standards that the coupled evaluation logic extends |
...
| **Tier** | Section |
| **Status** | ✓ Complete |
| **Assumes** | Module 1 §1.5, Module 1 §1.6, §4.3 |
